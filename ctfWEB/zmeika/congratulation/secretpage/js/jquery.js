"use stricsdet";
(self.webpackCcdechunk_N_E = self.webpackChunk_N_E || []).push([[960], {
    75927: function(e, t, r) {
        ...
        class i {
            constructor(e, t) {
                ...
                var r = "KaTeX parse error: " + e
                  , a = t && t.loc;
                if (a && a.start <= a.end) {
                    var n, s = a.lexer.input;
                    n = a.start;
                    var o = a.end;
                    n === s.length ? r += " at end of input: " : r += " at position " + (n + 1) + ": ";
                    var l = s.slice(n, o).replace(/[^]/g, "$&̲");
                    r += (n > 15 ? "…" + s.slice(n - 15, n) : s.slice(0, n)) + l + (o + 15 < s.length ? s.slice(o, o + 15) + "…" : s.slice(o))
                }
                var h = Error(r);
        ...
        var s, o, l, h, m, c, p, u, d, g = /([A-Z])/g, f = {
            "&": "&amp;",
            ">": "&gt;",
            "<": "&lt;",
            '"': "&quot;",
            ...
            if (!e)
                throw Error("Expected non-null, but got " + String(e));
            return e
        }, x = {
        ...
        class k {
            constructor(e) {
                ...
                w)
                    if (w.hasOwnProperty(t)) {
                        var r = w[t];
                        this[t] = void 0 !== e[t] ? r.processor ? r.processor(e[t]) : e[t] : function(e) {
                            if (e.default)
                                return e.default;
                            var t = e.type
            ...
            isTrusted(e) {
                return e.url && !e.protocol && (e.protocol = x.protocolFromUrl(e.url)),
        ...
        var M = [new S(0,0,!1), new S(1,0,!0), new S(2,1,!1), new S(3,1,!0), new S(4,2,!1), new S(5,2,!0), new S(6,3,!1), new S(7,3,!0)]
          , z = [4, 5, 4, 5, 6, 7, 6, 7]
          , A = [5, 5, 5, 5, 7, 7, 7, 7]
          , T = [2, 3, 4, 5, 6, 7, 6, 7]
          , B = [3, 3, 5, 5, 7, 7, 7, 7]
        ...
        function G(e, t, r) {
            if (!P[t])
                throw Error("Font metrics not found for font: " + t + ".");
            var a = e.charCodeAt(0)
              , n = P[t][a];
            if (!n && e[0]in V && (a = V[e[0]].charCodeAt(0),
            n = P[t][a]),
        ...
        var U = {}
          , Y = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]]
          , X = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488]
          , W = function(e, t) {
        ...
        class _ {
            ...
            havingBaseStyle(e) {
                ...
                return this.size === t && this.textSize === _.BASESIZE && this.style === e ? this : this.extend({
                    style: e,
                    size: t
                })
            }
            ...
            baseSizingClasses() {
                return this.size !== _.BASESIZE ? ["sizing", "reset-size" + this.size, "size" + _.BASESIZE] : []
            }
            fontMetrics() {
                return this._fontMetrics || (this._fontMetrics = function(e) {
                    ...
                    if (!U[t = e >= 5 ? 0 : e >= 3 ? 1 : 2]) {
                        var r = U[t] = {
                            cssEmPerMu: F.quad[t] / 18
                        };
                        for (var a in F)
                            F.hasOwnProperty(a) && (r[a] = F[a][t])
                    }
                    return U[t]
                }(this.size)),
                this._fontMetrics
        ...
        var j = {
          ...
          , et = function(e) {
            ...
            for (var r in t.className = Q(this.classes),
            this.style)
          ...
          , er = function(e) {
            var t = "<" + e;
            this.classes.length && (t += ' class="' + x.escape(Q(this.classes)) + '"');
            var r = "";
            for (var a in this.style)
                this.style.hasOwnProperty(a) && (r += x.hyphenate(a) + ":" + this.style[a] + ";");
            for (var n in r && (t += ' style="' + x.escape(r) + '"'),
            this.attributes)
                this.attributes.hasOwnProperty(n) && (t += " " + n + '="' + x.escape(this.attributes[n]) + '"');
            t += ">";
        ...
        class eo {
            ...
            toNode() {
                var e = document.createTextNode(this.text)
                  , t = null;
                for (var r in this.italic > 0 && ((t = document.createElement("span")).style.marginRight = J(this.italic)),
                this.classes.length > 0 && ((t = t || document.createElement("span")).className = Q(this.classes)),
                this.style)
        ...
        class eh {
            ...
            toNode() {
                ...
                return this.alternate ? e.setAttribute("d", this.alternate) : e.setAttribute("d", L[this.pathName]),
                e
            }
            toMarkup() {
                return this.alternate ? "<path d='" + this.alternate + "'/>" : "<path d='" + L[this.pathName] + "'/>"
            }
        }
        class em {
            constructor(e) {
        ...
        for (var eH = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", eE = 0; eE < eH.length; eE++) {
            var eL = eH.charAt(eE);
            eg(ef, eb, ek, eL, eL),
            eg(ev, eb, eT, eL, eL)
        }
        ...
        for (var eD = "", eP = 0; eP < eH.length; eP++) {
            ...
            eg(ev, eb, eT, eF, eD),
            eP < 26 && (eg(ef, eb, ek, eF, eD = String.fromCharCode(55349, 56632 + eP)),
            eg(ev, eb, eT, eF, eD),
        ...
        var eW = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["", "", ""], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]]
          , e_ = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]]
          , ej = function(e, t) {
            ...
            if (120485 === r || 120486 === r)
                return [eW[0][2], eW[0][a]];
            if (120486 < r && r < 120782)
                return ["", ""];
            throw new i("Unsupported character: " + e)
        }
          , e$ = function(e, t, r) {
            return ed[r][e] && ed[r][e].replace && (e = ed[r][e].replace),
            {
                value: e,
                metrics: G(e, t, r)
            }
          ...
          , eK = (e,t)=>{
            if (Q(e.classes) !== Q(t.classes) || e.skew !== t.skew || e.maxFontSize !== t.maxFontSize)
                return !1;
          ...
          , e4 = function(e) {
            ...
            if ("top" === e.positionType) {
                ...
                if ("shift" === e.positionType)
                    t = -p.elem.depth - e.positionData;
                else if ("firstBaseline" === e.positionType)
                    t = -p.elem.depth;
                else
                    throw Error("Invalid positionType " + e.positionType + ".")
            }
            return {
                children: e.children,
                depth: t
          ...
          , e5 = (e,t)=>{
            var r = eQ(["mspace"], [], t)
              , a = K(e, t);
            return r.style.marginRight = J(a),
            r
        }
          , e6 = function(e, t, r) {
            var a = "";
          ...
          , e8 = {
            ...
            mathsym: function(e, t, r, a) {
                return (void 0 === a && (a = []),
                "boldsymbol" === r.font && e$(e, "Main-Bold", t).metrics) ? eZ(e, "Main-Bold", t, r, a.concat(["mathbf"])) : "\\" === e || "main" === ed[t][e].font ? eZ(e, "Main-Regular", t, r, a) : eZ(e, "AMS-Regular", t, r, a.concat(["amsrm"]))
            },
            makeSpan: eQ,
            makeSvgSpan: e0,
            ...
            makeVList: function(e, t) {
                for (var r, {children: a, depth: n} = e4(e), i = 0, s = 0; s < a.length; s++) {
                    var o = a[s];
                    if ("elem" === o.type) {
                        var l = o.elem;
                ...
                c < 0) {
                    ...
                    r = [eQ(["vlist-r"], [b])];
                var k = eQ(["vlist-t"], r);
                return 2 === r.length && k.classes.push("vlist-t2"),
                k.height = p,
                k.depth = -c,
                k
            },
            makeOrd: function(e, t, r) {
                ...
                if (o) {
                    if ("boldsymbol" === o) {
                        var m, c, p = "textord" !== r && e$(n, "Math-BoldItalic", a).metrics ? {
                        ...
                        s ? (m = e7[o].fontName,
                        c = [o]) : (m = e6(o, t.fontWeight, t.fontShape),
                        c = [o, t.fontWeight, t.fontShape]);
                    if (e$(n, m, a).metrics)
                        return eZ(n, m, a, t, i.concat(c));
                ...
                if ("textord" === r) {
                    ...
                    if ("ams" === g)
                        return eZ(n, e6("amsrm", t.fontWeight, t.fontShape), a, t, i.concat("amsrm", t.fontWeight, t.fontShape));
                    if ("main" === g || !g)
                        return eZ(n, e6("textrm", t.fontWeight, t.fontShape), a, t, i.concat(t.fontWeight, t.fontShape));
            ...
            tryCombineChars: e=>{
                for (var t = 0; t < e.length - 1; t++) {
                    var r = e[t]
                      , a = e[t + 1];
                    r instanceof eo && a instanceof eo && eK(r, a) && (r.text += a.text,
          ...
          , ti = {};
        function ts(e) {
            for (var {type: t, names: r, props: a, handler: n, htmlBuilder: i, mathmlBuilder: s} = e, o = {
                type: t,
                numArgs: a.numArgs,
                argTypes: a.argTypes,
        ...
        var tl = function(e) {
          ...
          , tg = function(e, t, r, a) {
            ...
            if (e8.tryCombineChars(n),
            !r)
                return n;
            var l = t;
            if (1 === e.length) {
                var h = e[0];
                "sizing" === h.type ? l = t.havingSize(h.size) : "styling" === h.type && (l = t.havingStyle(tu[h.style]))
            }
            ...
            return tf(n, (e,t)=>{
                var r = t.classes[0]
                  , a = e.classes[0];
                "mbin" === r && x.contains(tp, a) ? t.classes[0] = "mord" : "mbin" === a && x.contains(tc, r) && (e.classes[0] = "mord")
            }
            , {
                node: m
            }, c, p),
            tf(n, (e,t)=>{
                var r = ty(t)
                  , a = ty(e)
                  , n = r && a ? e.hasClass("mtight") ? tr[r][a] : tt[r][a] : null;
                if (n)
                    return e8.makeGlue(n, l)
            }
            , {
                node: m
            }, c, p),
          ...
          , tf = function e(t, r, a, n, i) {
            ...
            for (var s = 0; s < t.length; s++) {
                ...
                if (m) {
                    var c = r(l, a.node);
                    c && (a.insertAfter ? a.insertAfter(c) : (t.unshift(c),
                    s++))
                }
                m ? a.node = l : i && l.hasClass("newline") && (a.node = tm(["leftmost"])),
                a.insertAfter = (o = s,
                e=>{
                    t.splice(o + 1, 0, e),
                    s++
          ...
          , tv = function(e) {
            return e instanceof D || e instanceof en || e instanceof ea && e.hasClass("enclosing") ? e : null
        }
          , tb = function e(t, r) {
            var a = tv(t);
            if (a) {
        ...
        function tk(e, t) {
            var r = tm(["base"], e, t)
              , a = tm(["strut"]);
            return a.style.height = J(r.height + r.depth),
        ...
        function tS(e, t) {
            var r, a, n = null;
            1 === e.length && "tag" === e[0].type && (n = e[0].tag,
            e = e[0].body);
            var i = tg(e, t, "root");
            ...
            for (var s = [], o = [], l = 0; l < i.length; l++)
                ...
                i[l].hasClass("mbin") || i[l].hasClass("mrel") || i[l].hasClass("allowbreak")) {
                    for (var h = !1; l < i.length - 1 && i[l + 1].hasClass("mspace") && !i[l + 1].hasClass("newline"); )
                        l++,
                        o.push(i[l]),
                        i[l].hasClass("nobreak") && (h = !0);
                    h || (s.push(tk(o, t)),
                    o = [])
                } else
                    i[l].hasClass("newline") && (o.pop(),
                    o.length > 0 && (s.push(tk(o, t)),
                    o = []),
                    s.push(i[l]));
            o.length > 0 && s.push(tk(o, t)),
            n ? ((a = tk(tg(n, t, !0))).classes = ["tag"],
            s.push(a)) : r && s.push(r);
        ...
        class tz {
            ...
            toMarkup() {
                ...
                this.classes.length > 0 && (e += ' class ="' + x.escape(Q(this.classes)) + '"'),
                e += ">";
                for (var r = 0; r < this.children.length; r++)
                    e += this.children[r].toMarkup();
                return e + ("</" + this.type) + ">"
        ...
        var tT = {
          ...
          , tB = function(e, t, r) {
            return ed[t][e] && ed[t][e].replace && 55349 !== e.charCodeAt(0) && !(eB.hasOwnProperty(e) && r && (r.fontFamily && "tt" === r.fontFamily.substr(4, 2) || r.font && "tt" === r.font.substr(4, 2))) && (e = ed[t][e].replace),
            new tT.TextNode(e)
        }
          , tC = function(e) {
          ...
          , tq = function(e, t) {
            ...
            if ("mathsf" === r)
                ...
                return "monospace";
            var n = e.text;
            return x.contains(["\\imath", "\\jmath"], n) ? null : (ed[a][n] && ed[a][n].replace && (n = ed[a][n].replace),
            G(n, e8.fontMap[r].fontName, a)) ? e8.fontMap[r].variant : null
        }
          , tN = function(e, t, r) {
            if (1 === e.length) {
                var a, n = tR(e[0], t);
                return r && n instanceof tz && "mo" === n.type && (n.setAttribute("lspace", "0em"),
            ...
            for (var i = [], s = 0; s < e.length; s++) {
                ...
                if (o instanceof tz && a instanceof tz) {
                    if ("mtext" === o.type && "mtext" === a.type && o.getAttribute("mathvariant") === a.getAttribute("mathvariant") || "mn" === o.type && "mn" === a.type) {
                    ...
                    if ("mi" === o.type && 1 === o.children.length && "mn" === a.type) {
                        ...
                        var h = a.children[0];
                        if (h instanceof tA && "̸" === h.text && ("mo" === o.type || "mi" === o.type || "mn" === o.type)) {
                            var m = o.children[0];
                            m instanceof tA && m.text.length > 0 && (m.text = m.text.slice(0, 1) + "̸" + m.text.slice(1),
                            i.pop())
                        }
                    }
                }
          ...
          , tR = function(e, t) {
            ...
            if (ti[e.type])
                return ti[e.type](e, t);
            throw new i("Got group of unknown type: '" + e.type + "'")
        };
        function tO(e, t, r, a, n) {
            var i, s = tN(e, r);
            i = 1 === s.length && s[0]instanceof tz && x.contains(["mrow", "mtable"], s[0].type) ? s[0] : new tT.MathNode("mrow",s);
        ...
        var tH = function(e) {
          ...
          , tL = function(e, t, r) {
            var a, n = tH(r);
            if ("mathml" === r.output)
                return tO(e, t, n, r.displayMode, !0);
            if ("html" === r.output) {
                var i = tS(e, n);
          ...
          , tV = {
            encloseSpan: function(e, t, r, a, n) {
                ...
                if (/fbox|color|angl/.test(t)) {
                    ...
                    var l = [];
                    /^[bx]cancel$/.test(t) && l.push(new em({
                        x1: "0",
                        y1: "0",
                        x2: "100%",
                        y2: "100%",
            ...
            mathMLnode: function(e) {
                var t = new tT.MathNode("mo",[new tT.TextNode(tP[e.replace(/^\\/, "")])]);
            ...
            svgSpan: function(e, t) {
                var {span: r, minWidth: a, height: n} = function() {
                    var r = 4e5
                      , a = e.label.substr(1);
                    if (x.contains(["widehat", "widecheck", "widetilde", "utilde"], a)) {
                        var n, i, s, o, l = "ordgroup" === (o = e.base).type ? o.body.length : 1;
                        if (l > 5)
                            ...
                            var h = [1, 1, 2, 2, 3, 3][l];
                            "widehat" === a || "widecheck" === a ? (r = [0, 1062, 2364, 2364, 2364][h],
                            n = [0, 239, 300, 360, 420][h],
                            s = [0, .24, .3, .3, .36, .42][h],
                            i = a + h) : (r = [0, 600, 1033, 2339, 2340][h],
                            n = [0, 260, 286, 306, 312][h],
                            s = [0, .26, .286, .3, .306, .34][h],
                            i = "tilde" + h)
                        }
                        var m = new eh(i)
                          , c = new el([m],{
                    ...
                    var p, u, d = [], g = tF[a], [f,v,b] = g, y = b / 1e3, w = f.length;
                    if (1 === w)
                        p = ["hide-tail"],
                        u = [g[3]];
                    else if (2 === w)
        ...
        function tG(e, t) {
            if (!e || e.type !== t)
                throw Error("Expected node of type " + t + ", but got " + (e ? "node of type " + e.type : String(e)));
            return e
        }
        function tU(e) {
            var t = tY(e);
            if (!t)
                throw Error("Expected node of symbol group type, but got " + (e ? "node of type " + e.type : String(e)));
            return t
        }
        function tY(e) {
        ...
        var tX = (e,t)=>{
            e && "supsub" === e.type ? (o = (l = tG(e.base, "accent")).base,
            e.base = o,
            h = function(e) {
                if (e instanceof ea)
                    return e;
            ...
            if (l.isStretchy)
                ...
                "\\vec" === l.label ? (c = e8.staticSvg("vec", t),
                p = e8.svgData.vec[1]) : ((c = ec(c = e8.makeOrd({
                    mode: l.mode,
                    text: l.label
                }, t, "textord"))).italic = 0,
                p = c.width,
                ...
                var o, l, h, m, c, p, u = "\\textcircled" === l.label;
                u && (m.classes.push("accent-full"),
                s = r.height);
                var d = n;
                u || (d -= p / 2),
                m.style.left = J(d),
            ...
            return h ? (h.children[0] = g,
            h.height = Math.max(g.height, h.height),
            h.classes[0] = "mord",
            h) : g
        }
          , tW = (e,t)=>{
            var r = e.isStretchy ? tV.mathMLnode(e.label) : new tT.MathNode("mo",[tB(e.label, e.mode)])
              , a = new tT.MathNode("mover",[tR(e.base, t), r]);
            return a.setAttribute("accent", "true"),
            a
        }
          , t_ = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(e=>"\\" + e).join("|"));
        ts({
            type: "accent",
        ...
        ts({
            ...
            htmlBuilder(e, t) {
                var r, a, n = t.style, i = t.havingStyle(n.sup()), s = e8.wrapFragment(tw(e.body, i, t), t), o = "\\x" === e.label.slice(0, 2) ? "x" : "cd";
                s.classes.push(o + "-arrow-pad"),
                e.below && (i = t.havingStyle(n.sub()),
                (r = e8.wrapFragment(tw(e.below, i, t), t)).classes.push(o + "-arrow-pad"));
                var l = tV.svgSpan(e, t)
                  , h = -t.fontMetrics().axisHeight + .5 * l.height
                  , m = -t.fontMetrics().axisHeight - .5 * l.height - .111;
                if ((s.depth > .25 || "\\xleftequilibrium" === e.label) && (m -= s.depth),
                r) {
            ...
            mathmlBuilder(e, t) {
                ...
                e.body) {
                    ...
                    if (e.below) {
                        ...
                        r = new tT.MathNode("mover",[a, n])
                } else if (e.below) {
                    var s = tj(tR(e.below, t));
                    r = new tT.MathNode("munder",[a, s])
                } else
                    r = tj(),
                    r = new tT.MathNode("mover",[a, r]);
                return r
            }
        });
        var t$ = {
          ...
          , tJ = (e,t)=>("mathord" === e.type || "atom" === e.type) && e.text === t;
        ts({
            type: "cdlabel",
        ...
        ts({
            ...
            handler(e, t) {
                for (var r, {parser: a} = e, n = tG(t[0], "ordgroup").body, s = "", o = 0; o < n.length; o++)
                ...
                return l <= 65535 ? r = String.fromCharCode(l) : (l -= 65536,
                r = String.fromCharCode((l >> 10) + 55296, (1023 & l) + 56320)),
                {
                    type: "textord",
                    mode: a.mode,
                    text: r
        ...
        ts({
            ...
            handler(e) {
                ...
                var a = t.fetch();
                if (t1[a.text])
                    return ("\\global" === r || "\\\\globallong" === r) && (a.text = t1[a.text]),
        ...
        ts({
            ...
            handler(e) {
                var t, {parser: r, funcName: a} = e, n = r.gullet.popToken(), s = n.text;
                if (/^(?:[\\{}$&#^_]|EOF)$/.test(s))
        ...
        ts({
            ...
            handler(e) {
                var {parser: t, funcName: r} = e
                  ...
                  , n = t.gullet.popToken()
                  , i = t.gullet.popToken();
                return t6(t, a, i, "\\\\globalfuture" === r),
        ...
        var t7 = function(e, t, r) {
          ...
          , t9 = function(e, t, r, a, n, i) {
            var s = e8.makeSymbol(e, "Size" + t + "-Regular", n, a)
              , o = t3(e8.makeSpan(["delimsizing", "size" + t], [s], a), N.TEXT, a, i);
            return r && t8(o, a, N.TEXT),
            o
        }
          , re = function(e, t, r) {
            return {
                type: "elem",
                elem: e8.makeSpan(["delimsizinginner", "Size1-Regular" === t ? "delim-size1" : "delim-size4"], [e8.makeSpan([], [e8.makeSymbol(e, t, r)])])
            }
        }
          , rt = function(e, t, r) {
            var a = P["Size4-Regular"][e.charCodeAt(0)] ? P["Size4-Regular"][e.charCodeAt(0)][4] : P["Size1-Regular"][e.charCodeAt(0)][4]
          ...
          , ri = function(e, t, r, a, n, i) {
            ...
            "\\uparrow" === e ? l = h = "⏐" : "\\Uparrow" === e ? l = h = "‖" : "\\downarrow" === e ? s = l = "⏐" : "\\Downarrow" === e ? s = l = "‖" : "\\updownarrow" === e ? (s = "\\uparrow",
            l = "⏐",
            h = "\\downarrow") : "\\Updownarrow" === e ? (s = "\\Uparrow",
            l = "‖",
            h = "\\Downarrow") : x.contains(ra, e) ? l = "∣" : x.contains(rn, e) ? l = "∥" : "[" === e || "\\lbrack" === e ? (s = "⎡",
            l = "⎢",
            h = "⎣",
            m = "Size4-Regular") : "]" === e || "\\rbrack" === e ? (s = "⎤",
            l = "⎥",
            h = "⎦",
            m = "Size4-Regular") : "\\lfloor" === e || "⌊" === e ? (l = s = "⎢",
            h = "⎣",
            m = "Size4-Regular") : "\\lceil" === e || "⌈" === e ? (s = "⎡",
            l = h = "⎢",
            m = "Size4-Regular") : "\\rfloor" === e || "⌋" === e ? (l = s = "⎥",
            h = "⎦",
            m = "Size4-Regular") : "\\rceil" === e || "⌉" === e ? (s = "⎤",
            l = h = "⎥",
            m = "Size4-Regular") : "(" === e || "\\lparen" === e ? (s = "⎛",
            l = "⎜",
            h = "⎝",
            m = "Size4-Regular") : ")" === e || "\\rparen" === e ? (s = "⎞",
            l = "⎟",
            h = "⎠",
            m = "Size4-Regular") : "\\{" === e || "\\lbrace" === e ? (s = "⎧",
            o = "⎨",
            h = "⎩",
            l = "⎪",
            m = "Size4-Regular") : "\\}" === e || "\\rbrace" === e ? (s = "⎫",
            o = "⎬",
            h = "⎭",
            l = "⎪",
            m = "Size4-Regular") : "\\lgroup" === e || "⟮" === e ? (s = "⎧",
            h = "⎩",
            l = "⎪",
            m = "Size4-Regular") : "\\rgroup" === e || "⟯" === e ? (s = "⎫",
            h = "⎭",
            l = "⎪",
            m = "Size4-Regular") : "\\lmoustache" === e || "⎰" === e ? (s = "⎧",
            h = "⎭",
            l = "⎪",
            m = "Size4-Regular") : ("\\rmoustache" === e || "⎱" === e) && (s = "⎫",
            h = "⎩",
            l = "⎪",
            m = "Size4-Regular");
            var c = t7(s, m, n)
          ...
          , ro = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"]
          , rl = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"]
          , rh = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"]
          , rm = [0, 1.2, 1.8, 2.4, 3]
          , rc = [{
            type: "small",
          ...
          , rg = function(e, t, r, a) {
            for (var n = Math.min(2, 3 - a.style.size), i = n; i < r.length && "stack" !== r[i].type; i++) {
                var s = t7(e, rd(r[i]), "math")
                  , o = s.height + s.depth;
                if ("small" === r[i].type && (o *= a.havingBaseStyle(r[i].style).sizeMultiplier),
                o > t)
                    return r[i]
            }
            return r[r.length - 1]
          ...
          , rf = function(e, t, r, a, n, i) {
            ...
            var s, o = rg(e, t, s, a);
            return "small" === o.type ? t2(e, o.style, r, a, n, i) : "large" === o.type ? t9(e, o.size, r, a, n, i) : ri(e, t, r, a, n, i)
        }
          , rv = {
            sqrtImage: function(e, t) {
                var r, a, n = t.havingBaseSizing(), i = rg("\\surd", e * n.sizeMultiplier, ru, n), s = n.sizeMultiplier, o = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), l = 0, h = 0, m = 0;
                return "small" === i.type ? (m = 1e3 + 1e3 * o + 80,
                e < 1 ? s = 1 : e < 1.4 && (s = .7),
                l = (1 + o + .08) / s,
                h = (1 + o) / s,
                (r = rs("sqrtMain", l, m, o, t)).style.minWidth = "0.853em",
                a = .833 / s) : "large" === i.type ? (m = 1080 * rm[i.size],
                h = (rm[i.size] + o) / s,
                l = (rm[i.size] + o + .08) / s,
                (r = rs("sqrtSize" + i.size, l, m, o, t)).style.minWidth = "1.02em",
                a = 1 / s) : (l = e + o + .08,
                h = e + o,
                (r = rs("sqrtTall", l, m = Math.floor(1e3 * e + o) + 80, o, t)).style.minWidth = "0.742em",
                a = 1.056),
                r.height = h,
                r.style.height = J(l),
                {
          ...
          , ry = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];
        function rx(e, t) {
            var r = tY(e);
            if (r && x.contains(ry, r.text))
                return r;
            if (r)
                throw new i("Invalid delimiter '" + r.text + "' after '" + t.funcName + "'",e);
        ...
        ts({
            ...
            ,
            htmlBuilder: (e,t)=>"." === e.delim ? e8.makeSpan([e.mclass]) : rv.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
            mathmlBuilder: e=>{
                var t = [];
        ...
        ts({
            ...
            htmlBuilder: (e,t)=>{
                rw(e);
                for (var r, a, n = tg(e.body, t, !0, ["mopen", "mclose"]), i = 0, s = 0, o = !1, l = 0; l < n.length; l++)
                    n[l].isMiddle ? o = !0 : (i = Math.max(n[l].height, i),
                    s = Math.max(n[l].depth, s));
                if (i *= t.sizeMultiplier,
                s *= t.sizeMultiplier,
                r = "." === e.left ? tx(t, ["mopen"]) : rv.leftRightDelim(e.left, i, s, t, e.mode, ["mopen"]),
                n.unshift(r),
                o)
                    for (var h = 1; h < n.length; h++) {
                        var m = n[h].isMiddle;
                        m && (n[h] = rv.leftRightDelim(m.delim, i, s, m.options, e.mode, []))
                    }
                if ("." === e.right)
                    a = tx(t, ["mclose"]);
                else {
        ...
        ts({
            ...
            ,
            mathmlBuilder: (e,t)=>{
                var r = "\\vert" === e.delim || "|" === e.delim ? tB("|", "text") : tB(e.delim, e.mode)
        ...
        var rk = (e,t)=>{
            var r, a, n = e8.wrapFragment(tw(e.body, t), t), i = e.label.substr(1), s = t.sizeMultiplier, o = 0, l = x.isCharacterBox(e.body);
            if ("sout" === i)
                (r = e8.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / s,
                o = -.5 * t.fontMetrics().xHeight;
            else if ("phase" === i) {
                var h = K({
                    number: .6,
                    unit: "pt"
                ...
                var p = Math.floor(1e3 * c * s)
                  , u = new el([new eh("phase","M400000 " + p + " H0 L" + p / 2 + " 0 l65 45 L145 " + (p - 80) + " H400000z")],{
                    width: "400em",
                    height: J(p / 1e3),
                ...
                var d = 0
                  , g = 0
                  , f = 0;
                /box/.test(i) ? (f = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness),
                g = d = t.fontMetrics().fboxsep + ("colorbox" === i ? 0 : f)) : "angl" === i ? (d = 4 * (f = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness)),
                g = Math.max(0, .25 - n.depth)) : g = d = l ? .2 : 0,
                r = tV.encloseSpan(n, i, d, g, t),
                /fbox|boxed|fcolorbox/.test(i) ? (r.style.borderStyle = "solid",
                r.style.borderWidth = J(f)) : "angl" === i && .049 !== f && (r.style.borderTopWidth = J(f),
            ...
            return (/cancel/.test(i) && (a.height = n.height,
            a.depth = n.depth),
            /cancel/.test(i) && !l) ? e8.makeSpan(["mord", "cancel-lap"], [a], t) : e8.makeSpan(["mord"], [a], t)
        }
          , rS = (e,t)=>{
            var r = 0
              , a = new tT.MathNode(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose",[tR(e.body, t)]);
            switch (e.label) {
            case "\\cancel":
        ...
        function rq(e, t, r) {
            ...
            function k() {
                x && (e.gullet.macros.get("\\df@tag") ? (x.push(e.subparse([new n("\\df@tag")])),
                e.gullet.macros.set("\\df@tag", void 0, !0)) : x.push(!!m && "1" === e.gullet.macros.get("\\@eqnsw")))
            }
            for (w(),
            y.push(rT(e)); ; ) {
                ...
                if ("&" === M) {
                    ...
                    k(),
                    1 === f.length && "styling" === S.type && 0 === S.body[0].body.length && (v.length > 1 || !p) && v.pop(),
        ...
        var rI = function(e, t) {
            var r, a, n, s, o = e.body.length, l = e.hLinesBeforeRow, h = 0, m = Array(o), c = [], p = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness), u = 1 / t.fontMetrics().ptPerEm, d = 5 * u;
            e.colSeparationType && "small" === e.colSeparationType && (d = .2778 * (t.havingStyle(N.SCRIPT).sizeMultiplier / t.sizeMultiplier));
            var g = "CD" === e.colSeparationType ? K({
                number: 3,
                unit: "ex"
            }, t) : 12 * u
              , f = 3 * u
            ...
            if (e.tags && e.tags.some(e=>e))
                for (r = 0; r < o; ++r) {
                    var H = m[r]
                      ...
                      , L = e.tags[r]
                      , D = void 0;
                    (D = !0 === L ? e8.makeSpan(["eqn-num"], [], t) : !1 === L ? e8.makeSpan([], [], t) : e8.makeSpan([], tg(L, t, !0), t)).depth = H.depth,
                    D.height = H.height,
                    O.push({
                        type: "elem",
                        elem: D,
            ...
            for (a = 0,
            s = 0; a < h || s < I.length; ++a,
            ++s) {
                for (var P = I[s] || {}, F = !0; "separator" === P.type; ) {
                    if (F || ((n = e8.makeSpan(["arraycolsep"], [])).style.width = J(t.fontMetrics().doubleRuleSep),
                    R.push(n)),
                ...
                if (!(a >= h)) {
                    var Y = void 0;
                    (a > 0 || e.hskipBeforeAndAfter) && 0 !== (Y = x.deflt(P.pregap, d)) && ((n = e8.makeSpan(["arraycolsep"], [])).style.width = J(Y),
                    R.push(n));
                    var X = [];
                    for (r = 0; r < o; ++r) {
                        var W = m[r]
                    ...
                    R.push(X),
                    (a < h - 1 || e.hskipBeforeAndAfter) && 0 !== (Y = x.deflt(P.postgap, d)) && ((n = e8.makeSpan(["arraycolsep"], [])).style.width = J(Y),
                    R.push(n))
                }
            }
            if (m = e8.makeSpan(["mtable"], R),
            c.length > 0) {
                for (var $ = e8.makeLineSpan("hline", t, p), Z = e8.makeLineSpan("hdashline", t, p), Q = [{
                    type: "elem",
                    elem: m,
                    shift: 0
                }]; c.length > 0; ) {
            ...
            if (0 === O.length)
                return e8.makeSpan(["mord"], [m], t);
            var er = e8.makeVList({
                positionType: "individualShift",
                children: O
            }, t);
            return er = e8.makeSpan(["tag"], [er], t),
            e8.makeFragment([m, er])
        }
          , rR = {
            c: "center ",
            l: "left ",
          ...
          , rO = function(e, t) {
            for (var r = [], a = new tT.MathNode("mtd",[],["mtr-glue"]), n = new tT.MathNode("mtd",[],["mml-eqn-num"]), i = 0; i < e.body.length; i++) {
                ...
                e.tags && e.tags[i] && (o.unshift(a),
                o.push(a),
                e.leqno ? o.unshift(n) : o.push(n)),
          ...
          , rH = function(e, t) {
            ...
            var r, a = [], n = e.envName.indexOf("at") > -1 ? "alignat" : "align", s = "split" === e.envName, o = rq(e.parser, {
                cols: a,
                addJot: !0,
        ...
        rz({
            ...
            handler(e, t) {
                var r = (tY(t[0]) ? [t[0]] : tG(t[0], "ordgroup").body).map(function(e) {
                    var t = tU(e).text;
                    if (-1 !== "lcr".indexOf(t))
                        return {
                            type: "align",
        ...
        rz({
            ...
            handler(e, t) {
                ...
                if ((a = rq(e.parser, a, "script")).body.length > 0 && a.body[0].length > 1)
                    throw new i("{subarray} can contain only one column");
                return a
            },
            htmlBuilder: rI,
                        ...
                        if (tK(o[h])) {
                            ...
                            "=|.".indexOf(m) > -1)
                                ...
                                for (var p = 0; p < 2; p++) {
                                    ...
                                    if (u)
                                        throw new i("Missing a " + m + " character to complete a CD arrow.",o[h])
                                }
                            else
                                throw new i('Expected one of "<>AV=|." after @',o[h]);
                            var g = {
                                type: "styling",
                                body: [function(e, t, r) {
                                    var a = t$[e];
        ...
        ts({
            ...
            handler(e, t) {
                ...
                if ("\\begin" === a) {
                    ...
                    if (d.name !== s)
                        throw new i("Mismatch: \\begin{" + s + "} matched by \\end{" + d.name + "}",u);
                    return p
                }
                return {
                    type: "environment",
        ...
        function rD(e, t) {
            var r, a = tN(e.body, t);
            return "minner" === e.mclass ? r = new tT.MathNode("mpadded",a) : "mord" === e.mclass ? e.isCharacterBox ? (r = a[0]).type = "mi" : r = new tT.MathNode("mi",a) : (e.isCharacterBox ? (r = a[0]).type = "mo" : r = new tT.MathNode("mo",a),
        ...
        ts({
            ...
            handler(e, t) {
                var r, {parser: a, funcName: n} = e, i = t[1], s = t[0];
        ...
        var rU = (e,t)=>{
            var r = t;
            return "display" === e ? r = r.id >= N.SCRIPT.id ? r.text() : N.DISPLAY : "text" === e && r.size === N.DISPLAY.size ? r = N.TEXT : "script" === e ? r = N.SCRIPT : "scriptscript" === e && (r = N.SCRIPTSCRIPT),
            r
        }
          , rY = (e,t)=>{
            var r, a, n, i, s, o, l, h, m, c, p, u = rU(e.size, t.style), d = u.fracNum(), g = u.fracDen();
            r = t.havingStyle(d);
            ...
            if (e.hasBarLine ? (e.barSize ? (n = K(e.barSize, t),
            a = e8.makeLineSpan("frac-line", t, n)) : a = e8.makeLineSpan("frac-line", t),
            n = a.height,
            i = a.height) : (a = null,
            n = 0,
            i = t.fontMetrics().defaultRuleThickness),
            u.size === N.DISPLAY.size || "display" === e.size ? (s = t.fontMetrics().num1,
            o = n > 0 ? 3 * i : 7 * i,
            l = t.fontMetrics().denom1) : (n > 0 ? (s = t.fontMetrics().num2,
            o = i) : (s = t.fontMetrics().num3,
            o = 3 * i),
            l = t.fontMetrics().denom2),
            a) {
                var x = t.fontMetrics().axisHeight;
                s - f.depth - (x + .5 * n) < o && (s += o - (s - f.depth - (x + .5 * n))),
                x - .5 * n - (y.height - l) < o && (l += o - (x - .5 * n - (y.height - l)));
                var w = -(x - .5 * n);
                h = e8.makeVList({
                    positionType: "individualShift",
                    children: [{
            ...
            return r = t.havingStyle(u),
            h.height *= r.sizeMultiplier / t.sizeMultiplier,
            h.depth *= r.sizeMultiplier / t.sizeMultiplier,
            m = u.size === N.DISPLAY.size ? t.fontMetrics().delim1 : u.size === N.SCRIPTSCRIPT.size ? t.havingStyle(N.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2,
            c = null == e.leftDelim ? tx(t, ["mopen"]) : rv.customSizedDelim(e.leftDelim, m, !0, t.havingStyle(u), e.mode, ["mopen"]),
            p = e.continued ? e8.makeSpan([]) : null == e.rightDelim ? tx(t, ["mclose"]) : rv.customSizedDelim(e.rightDelim, m, !0, t.havingStyle(u), e.mode, ["mclose"]),
            e8.makeSpan(["mord"].concat(r.sizingClasses(t)), [c, e8.makeSpan(["mfrac"], [h]), p], t)
        }
          , rX = (e,t)=>{
            ...
            if (null != e.leftDelim || null != e.rightDelim) {
                var s = [];
                if (null != e.leftDelim) {
                    var o = new tT.MathNode("mo",[new tT.TextNode(e.leftDelim.replace("\\", ""))]);
        ...
        ts({
            ...
            handler: (e,t)=>{
                var r, {parser: a, funcName: n} = e, i = t[0], s = t[1], o = null, l = null, h = "auto";
                switch (n) {
                case "\\dfrac":
                case "\\frac":
                case "\\tfrac":
        ...
        ts({
            ...
            handler(e, t) {
                var r, {parser: a} = e, n = t[4], i = t[5], s = tl(t[0]), o = "atom" === s.type && "open" === s.family ? r_(s.text) : null, l = tl(t[1]), h = "atom" === l.type && "close" === l.family ? r_(l.text) : null, m = tG(t[2], "size"), c = null;
                r = !!m.isBlank || (c = m.value).number > 0;
                var p = "auto"
                  , u = t[3];
                return "ordgroup" === u.type ? u.body.length > 0 && (p = rW[Number(tG(u.body[0], "textord").text)]) : p = rW[Number((u = tG(u, "textord")).text)],
                {
                    type: "genfrac",
                    mode: a.mode,
                    numer: n,
        ...
        var rj = (e,t)=>{
            var r, a, n, i = t.style;
            "supsub" === e.type ? (r = e.sup ? tw(e.sup, t.havingStyle(i.sup()), t) : tw(e.sub, t.havingStyle(i.sub()), t),
            a = tG(e.base, "horizBrace")) : a = tG(e, "horizBrace");
            var s = tw(a.base, t.havingBaseStyle(N.DISPLAY))
              , o = tV.svgSpan(a, t);
            if (a.isOver ? (n = e8.makeVList({
                positionType: "firstBaseline",
                children: [{
                    type: "elem",
                    elem: s
            ...
            }, t)).children[0].children[0].children[1].classes.push("svg-align") : (n = e8.makeVList({
                positionType: "bottom",
        ...
        ts({
            ...
            mathmlBuilder: (e,t)=>{
                var r = tV.mathMLnode(e.label);
                return new tT.MathNode(e.isOver ? "mover" : "munder",[tR(e.base, t), r])
            }
        }),
        ts({
            type: "href",
            ...
            mathmlBuilder: (e,t)=>{
                var r = tI(e.body, t);
                return r instanceof tz || (r = new tz("mrow",[r])),
        ...
        ts({
            ...
            handler: (e,t)=>{
                var r, {parser: a, funcName: n, token: s} = e, o = tG(t[0], "raw").string, l = t[1];
        ...
        ts({
            ...
            handler: (e,t,r)=>{
                var {parser: a} = e
                  ...
                  , l = "";
                if (r[0])
                    for (var h = tG(r[0], "raw").string.split(","), m = 0; m < h.length; m++) {
                        var c = h[m].split("=");
                        if (2 === c.length) {
                            var p = c[1].trim();
                            switch (c[0].trim()) {
            ...
            mathmlBuilder: (e,t)=>{
                ...
                var a = K(e.height, t)
                  , n = 0;
                if (e.totalheight.number > 0 && (n = K(e.totalheight, t) - a,
                r.setAttribute("valign", J(-n))),
        ...
        ts({
            ...
            handler(e, t) {
                ...
                if (r.settings.strict) {
                    var i = "m" === a[1]
                      , s = "mu" === n.value.unit;
                    i ? (s || r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " supports only mu units, not " + n.value.unit + " units"),
                    "math" !== r.mode && r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " works only in math mode")) : s && r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + a + " doesn't support mu units")
                }
                return {
                    type: "kern",
                    mode: r.mode,
        ...
        ts({
            ...
            ,
            htmlBuilder: (e,t)=>{
                "clap" === e.alignment ? (r = e8.makeSpan([], [tw(e.body, t)]),
                r = e8.makeSpan(["inner"], [r], t)) : r = e8.makeSpan(["inner"], [tw(e.body, t)]);
                var r, a = e8.makeSpan(["fix"], []), n = e8.makeSpan([e.alignment], [r, a], t), i = e8.makeSpan(["strut"]);
                return i.style.height = J(n.height + n.depth),
        ...
        var rK = (e,t,r,a,n,i,s)=>{
            e = e8.makeSpan([], [e]);
            var o, l, h, m = r && x.isCharacterBox(r);
            if (t) {
          ...
          , rQ = (e,t)=>{
            ...
            var o = t.style
              , l = !1;
            if (o.size === N.DISPLAY.size && n.symbol && !x.contains(rJ, n.name) && (l = !0),
            n.symbol) {
                var h = l ? "Size2-Regular" : "Size1-Regular"
                  , m = "";
                if (("\\oiint" === n.name || "\\oiiint" === n.name) && (m = n.name.substr(1),
                n.name = "oiint" === m ? "\\iint" : "\\iiint"),
                i = e8.makeSymbol(n.name, h, "math", t, ["mop", "op-symbol", l ? "large-op" : "small-op"]),
                m.length > 0) {
                    var c = i.italic
                ...
                var u = tg(n.body, t, !0);
                1 === u.length && u[0]instanceof eo ? (i = u[0]).classes[0] = "mop" : i = e8.makeSpan(["mop"], u, t)
            } else {
            ...
            var f = 0
              , v = 0;
            return ((i instanceof eo || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (f = (i.height - i.depth) / 2 - t.fontMetrics().axisHeight,
            v = i.italic),
            s) ? rK(i, r, a, t, o, v, f) : (f && (i.style.position = "relative",
            i.style.top = J(f)),
            i)
        }
          , r0 = (e,t)=>{
        ...
        var r5 = (e,t)=>{
            ...
            s = !0) : n = tG(e, "operatorname"),
            n.body.length > 0) {
                for (var o = tg(n.body.map(e=>{
                    var t = e.text;
                    ...
                    var h = o[l];
                    h instanceof eo && (h.text = h.text.replace(/\u2212/, "-").replace(/\u2217/, "*"))
                }
        ...
        ;
        function r6(e, t, r) {
            for (var a = tg(e, t, !1), n = t.sizeMultiplier / r.sizeMultiplier, i = 0; i < a.length; i++) {
                var s = a[i].classes.indexOf("sizing");
                s < 0 ? Array.prototype.push.apply(a[i].classes, t.sizingClasses(r)) : a[i].classes[s + 1] === "reset-size" + t.size && (a[i].classes[s + 1] = "reset-size" + r.size),
                a[i].height *= n,
                a[i].depth *= n
            }
            ...
            mathmlBuilder: (e,t)=>{
                for (var r = tN(e.body, t.withFont("mathrm")), a = !0, n = 0; n < r.length; n++) {
                    ...
                    if (i instanceof tT.SpaceNode)
                        ...
                        case "mo":
                            var s = i.children[0];
                            1 === i.children.length && s instanceof tT.TextNode ? s.text = s.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : a = !1;
                            break;
                        default:
                            a = !1
                        }
        ...
        rA["\\operatorname"] = "\\@ifstar\\operatornamewithlimits\\operatorname@",
        to({
            type: "ordgroup",
            htmlBuilder: (e,t)=>e.semisimple ? e8.makeFragment(tg(e.body, t, !1)) : e8.makeSpan(["mord"], tg(e.body, t, !0), t),
        ...
        ts({
            ...
            htmlBuilder(e, t) {
                ...
                return r.style.borderRightWidth = J(a),
            ...
            mathmlBuilder(e, t) {
                ...
                return n >= 0 ? o.setAttribute("height", J(n)) : (o.setAttribute("height", J(n)),
                o.setAttribute("depth", J(-n))),
                o.setAttribute("voffset", J(n)),
                o
            }
        });
        var r7 = ["\\tiny", "\\sixptsize", "\\scriptsize", "\\footnotesize", "\\small", "\\normalsize", "\\large", "\\Large", "\\LARGE", "\\huge", "\\Huge"];
        ts({
            type: "sizing",
            names: r7,
            props: {
            ...
            mathmlBuilder: (e,t)=>{
                ...
                return n.setAttribute("mathsize", J(r.sizeMultiplier)),
                n
            }
        }),
        ts({
        ...
        ts({
            ...
            htmlBuilder(e, t) {
                ...
                if (!e.index)
                    return e8.makeSpan(["mord", "sqrt"], [p], t);
            ...
            mathmlBuilder(e, t) {
                ...
                return a ? new tT.MathNode("mroot",[tR(r, t), tR(a, t)]) : new tT.MathNode("msqrt",[tR(r, t)])
            }
        });
        var r3 = {
            display: N.DISPLAY,
        ...
        ts({
            ...
            mathmlBuilder(e, t) {
                ...
                return i.setAttribute("scriptlevel", s[0]),
        ...
        var r8 = function(e, t) {
            var r = e.base;
            return r ? "op" === r.type ? r.limits && (t.style.size === N.DISPLAY.size || r.alwaysHandleSupSub) ? rQ : null : "operatorname" === r.type ? r.alwaysHandleSupSub && (t.style.size === N.DISPLAY.size || r.limits) ? r5 : null : "accent" === r.type ? x.isCharacterBox(r.base) ? tX : null : "horizBrace" === r.type ? !e.sub === r.isOver ? rj : null : null : null
        };
        to({
            type: "supsub",
            htmlBuilder(e, t) {
                var r, a, n, i, s = r8(e, t);
                if (s)
                    return s(e, t);
                ...
                n = t.style === N.DISPLAY ? c.sup1 : t.style.cramped ? c.sup3 : c.sup2;
                ...
                if (r && a) {
                    p = Math.max(p, n, r.depth + .25 * c.xHeight),
                    u = Math.max(u, c.sub2);
            ...
            mathmlBuilder(e, t) {
                ...
                var i = [tR(e.base, t)];
                if (e.sub && i.push(tR(e.sub, t)),
                e.sup && i.push(tR(e.sup, t)),
                n)
                    a = r ? "mover" : "munder";
                else if (e.sub) {
                    if (e.sup) {
                        var s = e.base;
                        a = s && "op" === s.type && s.limits && t.style === N.DISPLAY ? "munderover" : s && "operatorname" === s.type && s.alwaysHandleSupSub && (t.style === N.DISPLAY || s.limits) ? "munderover" : "msubsup"
                    } else {
                        var o = e.base;
                        a = o && "op" === o.type && o.limits && (t.style === N.DISPLAY || o.alwaysHandleSupSub) ? "munder" : o && "operatorname" === o.type && o.alwaysHandleSupSub && (o.limits || t.style === N.DISPLAY) ? "munder" : "msub"
                    }
                } else {
                    var l = e.base;
                    a = l && "op" === l.type && l.limits && (t.style === N.DISPLAY || l.alwaysHandleSupSub) ? "mover" : l && "operatorname" === l.type && l.alwaysHandleSupSub && (l.limits || t.style === N.DISPLAY) ? "mover" : "msup"
                }
        ...
        to({
            type: "atom",
            htmlBuilder: (e,t)=>e8.mathsym(e.text, e.mode, t, ["m" + e.family]),
            mathmlBuilder(e, t) {
        ...
        to({
            ...
            mathmlBuilder(e, t) {
                var r = new tT.MathNode("mi",[tB(e.text, e.mode, t)])
                  , a = tq(e, t) || "italic";
                return a !== r2[r.type] && r.setAttribute("mathvariant", a),
                r
            }
        }),
        to({
            ...
            mathmlBuilder(e, t) {
                var r, a = tB(e.text, e.mode, t), n = tq(e, t) || "normal";
                return n !== r2[(r = "text" === e.mode ? new tT.MathNode("mtext",[a]) : /[0-9]/.test(e.text) ? new tT.MathNode("mn",[a]) : "\\prime" === e.text ? new tT.MathNode("mo",[a]) : new tT.MathNode("mi",[a])).type] && r.setAttribute("mathvariant", n),
                r
            }
        });
        var r9 = {
        ...
        to({
            ...
            htmlBuilder(e, t) {
                if (ae.hasOwnProperty(e.text)) {
                    ...
                    if ("text" !== e.mode)
                        return e8.makeSpan(["mspace", r], [e8.mathsym(e.text, e.mode, t)], t);
            ...
            mathmlBuilder(e, t) {
                ...
                else if (r9.hasOwnProperty(e.text))
        ...
        to({
            type: "tag",
            mathmlBuilder(e, t) {
                var r = new tT.MathNode("mtable",[new tT.MathNode("mtr",[at(), new tT.MathNode("mtd",[tI(e.body, t)]), at(), new tT.MathNode("mtd",[tI(e.tag, t)])])]);
        ...
        var ar = {
          ...
          , ai = (e,t)=>{
            var r = e.font;
            return r ? ar[r] ? t.withTextFontFamily(ar[r]) : aa[r] ? t.withTextFontWeight(aa[r]) : t.withTextFontShape(an[r]) : t
        }
        ;
        ts({
            type: "text",
        ...
        ts({
            ...
            mathmlBuilder: (e,t)=>new tT.MathNode("mpadded",[tR(e.body, t)],["vcenter"])
        }),
        ts({
            type: "verb",
            names: ["\\verb"],
            ...
            htmlBuilder(e, t) {
                for (var r = as(e), a = [], n = t.havingStyle(t.style.text()), i = 0; i < r.length; i++) {
                    var s = r[i];
                    "~" === s && (s = "\\textasciitilde"),
                    a.push(e8.makeSymbol(s, "Typewriter-Regular", e.mode, n, ["mord", "texttt"]))
                }
                return e8.makeSpan(["mord", "text"].concat(n.sizingClasses(t)), e8.tryCombineChars(a), n)
            },
            mathmlBuilder(e, t) {
        ...
        var as = e=>e.body.replace(/ /g, e.star ? "␣" : "\xa0")
          ...
          , al = "[̀-ͯ]"
          , ah = RegExp(al + "+$")
          , am = "(" + ao + "+)|\\\\(\n|[ \r	]+\n?)[ \r	]*|([!-\\[\\]-‧‪-퟿豈-￿]" + al + "*|[\uD800-\uDBFF][\uDC00-\uDFFF]" + al + "*|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5|(\\\\[a-zA-Z@]+)" + ao + "*|\\\\[^\uD800-\uDFFF])";
        class ac {
            constructor(e, t) {
                this.input = void 0,
            ...
            lex() {
                ...
                if (t === e.length)
                    return new n("EOF",new a(this,t,t));
                ...
                if (14 === this.catcodes[s]) {
                    ...
                    return -1 === o ? (this.tokenRegex.lastIndex = e.length,
                    this.settings.reportNonstrict("commentAtEnd", "% comment has no terminating newline; LaTeX would fail because of commenting the end of math mode (e.g. $)")) : this.tokenRegex.lastIndex = o + 1,
                    this.lex()
                }
        ...
        rA["\\char"] = function(e) {
            ...
            if ("'" === a.text)
                ...
                if ("\\" === (a = e.popToken()).text[0])
                    n = a.text.charCodeAt(1);
                else if ("EOF" === a.text)
        ...
        l = e=>ad(e, !0, !0),
        rA["\\providecommand"] = l,
        h = e=>(console.log(e.consumeArgs(1)[0].reverse().map(e=>e.text).join("")),
        ""),
        rA["\\message"] = h,
        m = e=>(console.error(e.consumeArgs(1)[0].reverse().map(e=>e.text).join("")),
        ""),
        rA["\\errmessage"] = m,
        c = e=>{
            var t = e.popToken()
              , r = t.text;
            return console.log(t, e.macros.get(r), ta[r], ed.math[r], ed.text[r]),
            ""
        }
        ,
        rA["\\show"] = c,
        ...
        rA["\\aa"] = "\\r a",
        rA["\\AA"] = "\\r A",
        rA["\\textcopyright"] = "\\html@mathml{\\textcircled{c}}{\\char`\xa9}",
        rA["\\copyright"] = "\\TextOrMath{\\textcopyright}{\\text{\\textcopyright}}",
        rA["\\textregistered"] = "\\html@mathml{\\textcircled{\\scriptsize R}}{\\char`\xae}",
        rA["ℬ"] = "\\mathscr{B}",
        rA["ℰ"] = "\\mathscr{E}",
        rA["ℱ"] = "\\mathscr{F}",
        rA["ℋ"] = "\\mathscr{H}",
        ...
        rA["∉"] = "\\notin",
        rA["≘"] = "\\html@mathml{\\mathrel{=\\kern{-1em}\\raisebox{0.4em}{$\\scriptsize\\frown$}}}{\\mathrel{\\char`≘}}",
        rA["≙"] = "\\html@mathml{\\stackrel{\\tiny\\wedge}{=}}{\\mathrel{\\char`≘}}",
        rA["≚"] = "\\html@mathml{\\stackrel{\\tiny\\vee}{=}}{\\mathrel{\\char`≚}}",
        rA["≛"] = "\\html@mathml{\\stackrel{\\scriptsize\\star}{=}}{\\mathrel{\\char`≛}}",
        rA["≝"] = "\\html@mathml{\\stackrel{\\tiny\\mathrm{def}}{=}}{\\mathrel{\\char`≝}}",
        rA["≞"] = "\\html@mathml{\\stackrel{\\tiny\\mathrm{m}}{=}}{\\mathrel{\\char`≞}}",
        rA["≟"] = "\\html@mathml{\\stackrel{\\tiny?}{=}}{\\mathrel{\\char`≟}}",
        rA["⟂"] = "\\perp",
        ...
        rA["️"] = "\\textregistered",
        rA["\\ulcorner"] = '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}',
        rA["\\urcorner"] = '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}',
        rA["\\llcorner"] = '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}',
        rA["\\lrcorner"] = '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}',
        ...
        rA["\\dots"] = function(e) {
            ...
            return r in ag ? t = ag[r] : "\\not" === r.substr(0, 4) ? t = "\\dotsb" : r in ed.math && x.contains(["bin", "rel"], ed.math[r].group) && (t = "\\dotsb"),
            t
        }
        ;
        var af = {
        ...
        ,
        rA["\\tag@literal"] = p,
        rA["\\bmod"] = "\\mathchoice{\\mskip1mu}{\\mskip1mu}{\\mskip5mu}{\\mskip5mu}\\mathbin{\\rm mod}\\mathchoice{\\mskip1mu}{\\mskip1mu}{\\mskip5mu}{\\mskip5mu}",
        rA["\\pod"] = "\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern8mu}{\\mkern8mu}{\\mkern8mu}(#1)",
        rA["\\pmod"] = "\\pod{{\\rm mod}\\mkern6mu#1}",
        rA["\\mod"] = "\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern12mu}{\\mkern12mu}{\\mkern12mu}{\\rm mod}\\,\\,#1",
        rA["\\pmb"] = "\\html@mathml{\\@binrel{#1}{\\mathrlap{#1}\\kern0.5px#1}}{\\mathbf{#1}}",
        rA["\\newline"] = "\\\\\\relax",
        rA["\\TeX"] = "\\textrm{\\html@mathml{T\\kern-.1667em\\raisebox{-.5ex}{E}\\kern-.125emX}{TeX}}";
        var av = J(P["Main-Regular"][84][1] - .7 * P["Main-Regular"][65][1]);
        rA["\\LaTeX"] = "\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{" + av + "}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}",
        rA["\\KaTeX"] = "\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{" + av + "}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}",
        ...
        rA["\\dblcolon"] = '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-.9mu}\\vcentcolon}}{\\mathop{\\char"2237}}',
        rA["\\coloneqq"] = '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}=}}{\\mathop{\\char"2254}}',
        rA["\\Coloneqq"] = '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}=}}{\\mathop{\\char"2237\\char"3d}}',
        rA["\\coloneq"] = '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}}}{\\mathop{\\char"3a\\char"2212}}',
        rA["\\Coloneq"] = '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}}}{\\mathop{\\char"2237\\char"2212}}',
        rA["\\eqqcolon"] = '\\html@mathml{\\mathrel{=\\mathrel{\\mkern-1.2mu}\\vcentcolon}}{\\mathop{\\char"2255}}',
        rA["\\Eqqcolon"] = '\\html@mathml{\\mathrel{=\\mathrel{\\mkern-1.2mu}\\dblcolon}}{\\mathop{\\char"3d\\char"2237}}',
        rA["\\eqcolon"] = '\\html@mathml{\\mathrel{\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\vcentcolon}}{\\mathop{\\char"2239}}',
        rA["\\Eqcolon"] = '\\html@mathml{\\mathrel{\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\dblcolon}}{\\mathop{\\char"2212\\char"2237}}',
        rA["\\colonapprox"] = '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\approx}}{\\mathop{\\char"3a\\char"2248}}',
        rA["\\Colonapprox"] = '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\approx}}{\\mathop{\\char"2237\\char"2248}}',
        rA["\\colonsim"] = '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\sim}}{\\mathop{\\char"3a\\char"223c}}',
        rA["\\Colonsim"] = '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\sim}}{\\mathop{\\char"2237\\char"223c}}',
        rA["∷"] = "\\dblcolon",
        rA["∹"] = "\\eqcolon",
        rA["≔"] = "\\coloneqq",
        rA["≕"] = "\\eqqcolon",
        ...
        rA["\\simcolon"] = "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}",
        rA["\\simcoloncolon"] = "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\dblcolon}",
        rA["\\approxcolon"] = "\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\vcentcolon}",
        rA["\\approxcoloncolon"] = "\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\dblcolon}",
        rA["\\notni"] = "\\html@mathml{\\not\\ni}{\\mathrel{\\char`∌}}",
        ...
        rA["\\llbracket"] = "\\html@mathml{\\mathopen{[\\mkern-3.2mu[}}{\\mathopen{\\char`⟦}}",
        rA["\\rrbracket"] = "\\html@mathml{\\mathclose{]\\mkern-3.2mu]}}{\\mathclose{\\char`⟧}}",
        rA["⟦"] = "\\llbracket",
        rA["⟧"] = "\\rrbracket",
        rA["\\lBrace"] = "\\html@mathml{\\mathopen{\\{\\mkern-3.2mu[}}{\\mathopen{\\char`⦃}}",
        rA["\\rBrace"] = "\\html@mathml{\\mathclose{]\\mkern-3.2mu\\}}}{\\mathclose{\\char`⦄}}",
        rA["⦃"] = "\\lBrace",
        rA["⦄"] = "\\rBrace",
        rA["\\minuso"] = "\\mathbin{\\html@mathml{{\\mathrlap{\\mathchoice{\\kern{0.145em}}{\\kern{0.145em}}{\\kern{0.1015em}}{\\kern{0.0725em}}\\circ}{-}}}{\\char`⦵}}",
        rA["⦵"] = "\\minuso",
        rA["\\darr"] = "\\downarrow",
        rA["\\dArr"] = "\\Downarrow",
        rA["\\Darr"] = "\\Downarrow",
        ...
        d = ab(!0),
        rA["\\bra@set"] = d,
        rA["\\Braket"] = "\\bra@ket{\\left\\langle}{\\,\\middle\\vert\\,}{\\,\\middle\\vert\\,}{\\right\\rangle}",
        ...
        class ax {
            ...
            scanArgument(e) {
                ...
                return this.pushToken(new n("EOF",r.loc)),
                this.pushTokens(a),
                t.range(r, "")
            }
            consumeSpaces() {
            ...
            consumeArg(e) {
                ...
                do {
                    ...
                    "{" === t.text)
                        ...
                        throw new i("Unexpected end of input in a macro argument, expected '" + (e && a ? e[o] : "}") + "'",t);
                    if (e && a) {
                ...
                return "{" === n.text && "}" === r[r.length - 1].text && (r.pop(),
                r.shift()),
                r.reverse(),
                {
                    tokens: r,
                    ...
                    for (var o = n.length - 1; o >= 0; --o) {
                        ...
                        if ("#" === l.text) {
                            ...
                            if ("#" === (l = n[--o]).text)
                                ...
                                throw new i("Not a valid argument number",l)
                        }
                    }
                }
            ...
            expandTokens(e) {
                ...
                for (this.pushTokens(e); this.stack.length > r; ) {
                    ...
                    a instanceof n && (a.treatAsRelax && (a.noexpand = !1,
                    a.treatAsRelax = !1),
            ...
            isDefined(e) {
                return this.macros.has(e) || ta.hasOwnProperty(e) || ed.math.hasOwnProperty(e) || ed.text.hasOwnProperty(e) || ay.hasOwnProperty(e)
            }
            isExpandable(e) {
                var t = this.macros.get(e);
                return null != t ? "string" == typeof t || "function" == typeof t || !t.unexpandable : ta.hasOwnProperty(e) && !ta[e].primitive
            }
        }
        ...
        class az {
            ...
            parseExpression(e, t) {
                for (var r = []; ; ) {
                    ...
                    var a = this.fetch();
                    if (-1 !== az.endOfExpression.indexOf(a.text) || t && a.text === t || e && ta[a.text] && ta[a.text].infix)
                        break;
            ...
            handleInfixNodes(e) {
                ...
                if (-1 === t || !a)
                    return e;
                var a, n, s, o = e.slice(0, t), l = e.slice(t + 1);
            ...
            parseAtom(e) {
                ...
                for (; ; ) {
                    ...
                    if ("\\limits" === n.text || "\\nolimits" === n.text) {
                        ...
                        if (t)
                            throw new i("Double superscript",n);
                        t = this.handleSupSubscript("superscript")
                    } else if ("_" === n.text) {
                        if (r)
                            throw new i("Double subscript",n);
            ...
            parseRegexGroup(e, t) {
                for (var r, a = this.fetch(), n = a, s = ""; "EOF" !== (r = this.fetch()).text && e.test(s + r.text); )
                    s += (n = r).text,
                    this.consume();
                if ("" === s)
                    throw new i("Invalid " + t + ": '" + a.text + "'",a);
                return a.range(n, s)
            }
            parseColorGroup(e) {
            ...
            parseSizeGroup(e) {
                ...
                if (!Z(n))
                    throw new i("Invalid unit: '" + n.unit + "'",t);
                return {
                    type: "size",
                    mode: this.mode,
                    value: n,
            ...
            parseGroup(e, t) {
                ...
                } else if (null == (r = this.parseFunction(t, e) || this.parseSymbol()) && "\\" === s[0] && !ay.hasOwnProperty(s)) {
                    if (this.settings.throwOnError)
                        throw new i("Undefined control sequence: " + s,n);
                    r = this.formatUnsupportedCmd(s),
                    this.consume()
                }
                return r
            }
            ...
            parseSymbol() {
                ...
                aM.hasOwnProperty(t[0]) && !ed[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e),
                t = aM[t[0]] + t.substr(1));
                var s = ah.exec(t);
                if (s && ("i" === (t = t.substring(0, s.index)) ? t = "ı" : "j" === t && (t = "ȷ")),
                ed[this.mode][t]) {
                    this.settings.strict && "math" === this.mode && eU.indexOf(t) >= 0 && this.settings.reportNonstrict("unicodeTextInMathMode", 'Latin-1/Unicode text character "' + t[0] + '" used in math mode', e);
                    var o, l = ed[this.mode][t].group, h = a.range(e);
                    ...
                    if (!(t.charCodeAt(0) >= 128))
                        return null;
                    this.settings.strict && (O(t.charCodeAt(0)) ? "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '" (' + t.charCodeAt(0) + ")", e)),
                    o = {
                        type: "textord",
                        mode: "text",
                        loc: a.range(e),
                ...
                s)
                    for (var m = 0; m < s[0].length; m++) {
                        var c = s[0][m];
                        if (!aS[c])
                            throw new i("Unknown accent ' " + c + "'",e);
                        var p = aS[c][this.mode] || aS[c].text;
                        if (!p)
                            throw new i("Accent " + c + " unsupported in " + this.mode + " mode",e);
                        o = {
                            type: "accent",
                            mode: this.mode,
                            loc: a.range(e),
